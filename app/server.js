...
server.put('/api/users/addSection/:id', api.put.user.addSection);
server.put('/api/users/removeSection/:id', api.put.user.removeSection);
server.put('/api/users/addAssignment/:id', api.put.user.addAssignment);
server.put('/api/users/removeAssignment/:id', api.put.user.removeAssignment);
